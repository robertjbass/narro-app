<template>
  <div class="front-page">
    ...
    <div class="blue-highlight">
      ...
      id, voluptatum, temporibus, suscipit repudiandae optio esse quaerat
      explicabo doloribus ipsa sint distinctio? Veniam perspiciatis aut, numquam
      natus iste assumenda quo incidunt et ducimus sequi, libero velit mollitia
      quisquam laborum voluptas corporis! Praesentium ea asperiores, officiis
      impedit veritatis recusandae eum error voluptatum totam eius consequuntur
      eveniet fugit nisi exercitationem, quidem tempore voluptates porro
      adipisci quisquam. Reiciendis quasi fuga itaque consectetur nihil labore
      et, architecto impedit sit nesciunt eveniet, incidunt ratione consequatur
      quo nemo molestias maiores consequuntur, error est laboriosam porro
      veritatis ex necessitatibus. Laudantium, ipsam quam? Facilis perferendis
...
.mysql-gradient {
  background-image: linear-gradient(to top right, #e48d0050, #00618a50);
}
.slack-gradient {
...
.copper-gradient {
  background-image: linear-gradient(to top right, #ffe9ee, #4e2f6550);
}
...
.typeform-gradient {
  background-image: linear-gradient(to top right, #33393f50, #89c6be);
}
...
.javascript-gradient {
  background-image: linear-gradient(to top right, #f5de19, #9d72d950);
}
...
.mongodb-gradient {
  background-image: linear-gradient(to top right, #c1bfbe50, #449945);
}
